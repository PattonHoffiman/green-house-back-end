...
let DeletePlantService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute(id, user_id) {
    ...
    if (!plant) throw new _AppError.default('This plant does not exists!');
    ...
    if (plants) {
      const updatedPlants = plants.filter(arrayPlant => arrayPlant.id !== plant.id);
...
exports.default = DeletePlantService;